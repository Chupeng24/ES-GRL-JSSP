...
parser.add_argument('--high', type=int, default=100, help='UB of duration')
parser.add_argument('--python_seed', type=int, default=200, help='Seed for numpy for training')
...
parser.add_argument('--max_updates', type=int, default=40000, help='No. of episodes of each env for training')
parser.add_argument('--lr', type=float, default=2.5e-5, help='lr')
